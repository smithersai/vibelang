...
`any` and `eval` are ordinary TypeScript in `.vibe`. General guidance may lint against them; the language does not forbid them and they no longer add a requirement.
