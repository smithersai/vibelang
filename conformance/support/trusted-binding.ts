 ...
 * **authored `.vibe`** — "Platform-specific globals ... MUST NOT be unconditional
 * globals in authored `.vibe` code. Host functionality MUST be represented by
 ...
 * complete syntax and behavior when imported by VibeLang."
 *
 * So the opt-out is the module boundary, and it is already specified. There is
 * no implementation-side opt-out claimable from `.vibe`, which is what makes
