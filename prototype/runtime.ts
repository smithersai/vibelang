// VibeScript runtime — the tiny ambient-context + failure-branding kernel.
...
export const FAILURE: unique symbol = Symbol.for("vibescript.failure") as any;
...
export function __vsUse(name: string): any {
  ...
  throw new Error(`VibeScript defect: capability '${name}' not provided`);
}
