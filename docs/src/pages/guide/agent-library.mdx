...
Replay reuses the recorded model response and completed calls. Generated code remains ordinary runtime TypeScript; it is not silently converted into a comptime Flow.
